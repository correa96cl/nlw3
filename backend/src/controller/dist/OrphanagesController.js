...
var OrphanageView_1 = require("../views/OrphanageView");
var Yup = require("yup");
exports["default"] = {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        orphanages = _a.sent();
                        return [2 /*return*/, response.json(OrphanageView_1["default"].renderMany(orphanages))];
                }
            });
        });
    },
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        orphanage = _a.sent();
                        return [2 /*return*/, response.json(OrphanageView_1["default"].render(orphanage))];
                }
            });
        });
    },
    create: function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, latitude, longitude, about, instructions, opening_hours, opening_on_weekends, orphanagesRepository, requestImages, images, data, schema, orphanage;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        console.log(request.files);
                        _a = request.body, name = _a.name, latitude = _a.latitude, longitude = _a.longitude, about = _a.about, instructions = _a.instructions, opening_hours = _a.opening_hours, opening_on_weekends = _a.opening_on_weekends;
                        orphanagesRepository = typeorm_1.getRepository(Orphanage_1["default"]);
